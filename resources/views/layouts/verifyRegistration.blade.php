...
<!-- footer main -->
    ...
    <table style="width: 100%;">
        <tr>
            <td>
                <table style="width: 100%; max-width: 650px; height: 60px; margin: auto; background:#F8F7FC">
                    <tr>
                        <td style="width: 40px;"></td>
                        <td><button style="padding: 8px 12px 8px 0; background-color: #F8F7FC; border:none; border-radius: 5px" ><a style="color: rgb(0, 0, 11); font-size:20px; text-decoration:none" href="{{route('returnBack')}}">Back</a></button> </td>
                        <td style="width: 40px;"></td>
                    </tr>
                </table>
            </td>
