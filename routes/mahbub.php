...
Route::group(['middleware'=>['auth']],function(){
    ...
    Route::get('polling/sub/category/create', [PollingSubCategoryController::class, 'polling_topic_create'])->name('polling_topic_create');
    Route::get('polling/sub/category/edit/{id}', [PollingSubCategoryController::class, 'polling_sub_category_edit'])->name('polling_sub_category_edit');
