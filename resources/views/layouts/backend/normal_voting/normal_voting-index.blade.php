...
@push('modals')
    ...
    <div class="modal reloadModal fade" id="addnormaltopic"  aria-labelledby="addnormaltopic" aria-hidden="true">
...
<div class="row mt-5">
                ...
                <table class="text-center table table-bordered table-fixed border-bottom" id="basic-datatable" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 600px !important">{{$norm->topic ?? ''}}</td>
                            <td>
                                {{$norm->option_one ?? ''}} 
    ...
    <!-- MODAL Edit EFFECTS -->
    @foreach ($normals as $norm)
        <div class="modal reloadModal fade" id="modaledit--{{$norm->id}}"  aria-labelledby="modaledit__{{$norm->id}}" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content pb-5">
                    <div class="modal-header">
                        <h5 class="modal-title">Update Topics</h5>
                    ...
                    <a href="" class="close_btn btn btn-danger" data-bs-dismiss="modal">Close</a>
                </div>
            </div>
