...
<div class="row mt-5">
                ...
                <table class="text-center table table-bordered text-nowrap border-bottom" id="basic-datatable" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @can('permission edit',)
                                <a href="" data-bs-toggle="modal" data-bs-target="#modaledit8__{{$role->id}}" class="btn btn-success">Edit Permission</a>
                                @endcan
                                
                                @can('role delete')
                                    @if ($role->id != 1)
                                    <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modaldemo8__{{$role->id}}">Delete</a>
                                    @endif
                                @endcan
                            </td>
                        </tr> 
                        ...
                        <div class="modal reloadModal fade" id="modaledit8__{{$role->id}}"  aria-labelledby="modaledit8__{{$role->id}}" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content pb-5">
                                    
                                    <div class="modal-body">
                                        <div class="modal-header">
                                            <h3 class="modal-title">{{$role->name}}</h3>
                                            <button type="button" class="close" style="background: none; border:none; outline:none; font-size:20px" data-bs-dismiss="modal" aria-label="Close">
                                    ...
                                    <a class="close_btn btn btn-danger text-white" data-bs-dismiss="modal">Close</a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Modal Add role-->
    <div class="modal reloadModal fade" id="addrolemodal_01"  aria-labelledby="addrolemodal_01" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content pb-5">
                <div class="modal-header">
                    <h5 class="modal-title">Create Role</h5>
                    <button type="button" class="close" style="background: none; border:none; outline:none; font-size:20px" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                ...
                <a class="close_btn btn btn-danger text-white" data-dismiss="modal">Close</a>
            </div>
        </div>
    </div>
