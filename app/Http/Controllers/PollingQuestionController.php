...
class PollingQuestionController extends Controller
{
    ...
    {
        // return $slug = Str::slug($request->question);
        $request->validate([
        ...
        $slug = $request->polling_category_id."-".$request->sub_category_id."-".Str::slug($request->question);
    ...
    public function update(Request $request, $id)
    {
        ...
        $slug = $cat->polling_category_id."-".$request->sub_category_id."-".Str::slug($request->question);
        // for save 
        $cat->sub_category_id = $request->sub_category_id;
        $cat->question = $request->question;
        $cat->slug = $slug;
