...
Route::group(['middleware'=>['auth']],function(){
    ...
    Route::get('verify/registration/template/view', [HomeController::class, 'verify_registration_view'])->name('verify_registration_view');
    Route::get('verify/registration/template/edit', [HomeController::class, 'verify_register_edit'])->name('verify_register_edit');
    Route::put('verify/registration/template/update/{id}', [HomeController::class, 'verify_register_update'])->name('verify_register_update');
    
    Route::get('user/survay/template/view', [HomeController::class, 'user_survay_view'])->name('user_survay_view');
    Route::get('user/survay/template/edit', [HomeController::class, 'user_survay_edit'])->name('user_survay_edit');
    Route::put('user/survay/template/update/{id}', [HomeController::class, 'user_survay_update'])->name('user_survay_template_update');

    Route::get('forget/password/template/view', [HomeController::class, 'forget_password_view'])->name('forget_password_view');
    Route::get('forget/password/template/edit', [HomeController::class, 'forget_password_edit'])->name('forget_password_edit');
    Route::put('forget/password/template/update/{id}', [HomeController::class, 'forget_password_update'])->name('forget_password_update');
