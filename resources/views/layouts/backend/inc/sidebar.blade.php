<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        ...
        <li class="slide {{ request()->routeIs(['user*','survay.index','admin_edit_user','admin_view_user']) ? 'is-expanded active' : '' }}">
            <a class="side-menu__item {{ request()->routeIs(['user*','survay.index','admin_edit_user','admin_view_user']) ? 'is-expanded active' : '' }}" data-bs-toggle="slide" href="javascript:void(0)"><i
            ...
            <ul class="slide-menu">
                ...
                <li><a href="{{ route('user.index') }}" class="slide-item {{ request()->routeIs(['user.index','admin_edit_user','admin_view_user']) ? 'active' : '' }}"> Users List</a></li>
                @endif
        ...
        <li class="slide {{ request()->routeIs(['polling_category*','polling_question*','question_option*','polling_normal*','polling_sub_cat*','normal_voting*','polling_topic_create']) ? 'is-expanded' : '' }}">
            <a class="side-menu__item {{ request()->routeIs(['polling_category*','polling_question*','question_option*','polling_normal*','polling_sub_cat*','normal_voting*','polling_topic_create']) ? 'active' : '' }}" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Polling</span><i class="angle fe fe-chevron-right"></i></a>
            <ul class="slide-menu {{ request()->routeIs(['polling_category*','polling_question*','question_option*','polling_normal*','polling_sub_cat*','normal_voting*','polling_topic_create']) ? 'open' : '' }}">
                ...
                <li class=""><a href="{{ route('polling_category.index') }}" class="sub-slide-item {{ request()->routeIs(['polling_category*','polling_sub_category_edit','polling_topic_create']) ? 'active' : '' }}">Topics (Live)</a></li>
                @endif

                @if(auth()->user()->can('live question create') || auth()->user()->can('live question edit') || auth()->user()->can('live question delete'))
                <li class=""><a href="{{ route('polling_question.index') }}" class="sub-slide-item {{ request()->routeIs(['polling_question*']) ? 'active' : '' }}">Questions(live)</a></li>
                @endif
        ...
        <li class="slide">
            <a class="side-menu__item has-link {{ request()->routeIs(['template','user_survay_view','user_survay_edit','verify_registration_view','verify_registration_edit','forget_password_view','forget_password_edit']) ? 'active' : '' }}" data-bs-toggle="slide" href="{{ route('template') }}"><i
