    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content pb-5">
            <div class="modal-header">
                <h5 class="modal-title">Add Survay Question</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('survay_question.store') }}" method="post">
                    ...
                    <div class="mt-3 mb-3" class="specific_country">
                        ...
                        <select class="survay_option_dropdown form-control" name="answer_type" data-flag="true" placeholder="C">
    ...
    <div class="col-md-12 m-auto">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Survay Question</li>
            </ol>
          </nav>
        <div class="card p-3 mt-4">
            <div class="category_title my-3 d-flex justify-content-between">
               ...
               <div class="right">
                ...
                <a class="btn btn-primary" href="" data-toggle="modal" data-target="#addquestionmodal_01">Add Survay Question</a>
                @endcan
           </div>
            </div>
            <div class="table-responsive">
                <table class="table table-bordered table-fixed border-bottom" id="basic-datatable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $loop->index+1 }}</td>
                            <td style="width: 600px !important">{{ $survay->survay_question ?? '' }}</td>
                            <td>
                                @php
                            ...
                            <td style="width: 400px !important; padding-left: 30px">
                        ...
                        <div class="modal fade" id="modaledit__{{$survay->id}}">
                            <div class="modal-dialog modal-lg modal-dialog-centered text-center" role="document"> 
                                <div class="modal-content modal-content-demo">
                                    <div class="modal-header">
                                        <h5 class="modal-title"> Survay Question <span class="text-danger">*</span></h5>
                                    ...
                                    <div class="card-body text-center">
                                        <form action="{{ route('survay_question.update', $survay->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group mb-2">
                                                <input type="submit" class="form-control btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter{{$survay->id}}" value="Update">
                                            </div>
                                        </form> 
                                    </div>
                                </div>
...
@section('scripts')
    <script type="text/javascript"> 
        ...
        $(document).ready(function(){
            $('.selType').hide();
            $('.survay_option_dropdown').change(function(){
                let valu = $(this).val()
                if(valu == 'select'){
                    $('.selType').show();
                }else{
        ...
        $(document).ready(function () {
            $('#add_more').click(function (){
                ...
                `<div class="row new_properties">
                    <div class="col-10">
                        <input type="text" placeholder="options" required name="options[]" class="form-control mb-1">
                    </div>
                    <div class="col-2">
