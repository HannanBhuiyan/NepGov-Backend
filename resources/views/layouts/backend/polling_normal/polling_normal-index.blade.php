                    ...
                    <form action="{{ route('polling_normal.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row new_properties mb-1">
                                <div class="col-10">
                                    <input type="text" required class="form-control" name="option[]" placeholder="Options">
                                </div>
                                <div class="col-2">
                                    <button type="button" class="close remove--new_properties">
                                        <span>&times;</span>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js"></script>
    ...
    $(document).ready(function () {
        $('#add_more').click(function (){
            ...
            `<div class="row new_properties">
                <div class="col-10">
                    <input placeholder="Options Update" required type="text" name="option[]" class="form-control mb-1">
                </div>
                <div class="col-2">
                <button type="button" class="close remove--new_properties">
                    <span>&times;</span>
    ...
    <script>
        $(document).ready(function () {
            $('.add_more_option').click(function (){
                ...
                `<div class="row new_properties">
                    <div class="col-10">
                        <input placeholder="Options" required type="text" name="option[]" class="form-control mb-1">
                    </div>
                    <div class="col-2">
                    <button type="button" class="close remove--new_properties">
                        <span>&times;</span>
